...
<html>
  ...
  <body class="hold-transition skin-blue fixed sidebar-mini">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <select id="target" name="target" class="form-control select2" onchange="java_script_:show(this.options[this.selectedIndex].value)" >
                    <option selected="selected" value="-1"> Please select one </option>
                    <option value="0" > Datasets </option>
                    <option value="1" > Ontologies </option>
                    <option value="2"> Summaries </option>
                  </select>
                </div>

                <div id="summaries" style="visibility:hidden" >
                ...
                <div id="datasets" style="visibility:hidden" >
                ...
                <div  id="ontologies" style="visibility:hidden" >
                  <table id="example2" class="table table-bordered table-hover">
                    <thead>
                      <tr>
                        <th>Name</th>
    ...
    <script type="text/javascript">
      function show(aval) {    
        if (aval == "0") {
          datasets.style.visibility='visible';
          datasets.style.display='block';
          ontologies.style.visibility='hidden';
          ontologies.style.display='none';
          summaries.style.visibility='hidden';
          summaries.style.display='none';
          Form.fileURL.focus();
         } 
        else if (aval == "1") {
          datasets.style.visibility='hidden';
          datasets.style.display='none';
          ontologies.style.visibility='visible';
          ontologies.style.display='block';
          summaries.style.visibility='hidden';
          summaries.style.display='none';
          Form.fileURL.focus();
         } 
          ...
          ontologies.style.visibility='hidden';
          ontologies.style.display='none';
          summaries.style.visibility='visible';
